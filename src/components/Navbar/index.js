  ...
  return (
    <>
      ...
      <NavLinkage to='/eciks' >
        ...
        <NavLinkage to='/tcap' >
          <img src={require('../../images/GCFLogo.png')} alt='logo' style={{width:"65px", height:"40px",marginTop:"5px"}}/>
        </NavLinkage>
        <NavLinkage to='/tcap' >
          <img src={require('../../images/unep.png')} alt='logo' style={{width:"80px", height:"40px",marginTop:"5px"}}/>
        </NavLinkage>
